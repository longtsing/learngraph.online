...
![Deep Agent 架构总览](./images/deep-agent-architecture.png)
...
![Deep Agent 配置架构](./images/deep-agent-config-architecture.png)
...
![子智能体架构](./images/deep-agent-subagent-architecture.png)
...
![Human-in-the-Loop 流程](./images/deep-agent-human-in-the-loop.png)
...
![长期记忆架构](./images/deep-agent-path-router.png)

```mermaid
graph LR
    A[Deep Agent] --> B[Path Router]
    B -->|/memories/*| C[Store Backend]
    B -->|其他路径| D[State Backend]
...
![中间件架构](./images/deep-agent-middleware-architecture.png)
