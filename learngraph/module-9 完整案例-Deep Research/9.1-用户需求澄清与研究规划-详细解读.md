...
- [LangGraph Scoping 官方指南](https://langchain-ai.github.io/langgraph/tutorials/rag/langgraph_agentic_rag/)
- [Structured Output 文档](https://python.langchain.com/docs/how_to/structured_output/)
- [Command 对象详解](https://langchain-ai.github.io/langgraph/how-tos/graph-api/#combine-control-flow-and-state-updates-with-command)
- [LLM-as-judge 最佳实践](https://hamel.dev/blog/posts/llm-judge/)
