...
默认情况下，`MultiServerMCPClient` 是**无状态**的——每次工具调用都会创建新的会话。这对于简单的无状态工具很方便，但有些工具需要**跨调用保持状态**（比如数据库连接、文件句柄等）。
...
- [LangChain MCP 官方文档](https://langchain-ai.github.io/langgraph/agents/tools/mcp/)
- [Anthropic MCP 协议官网](https://modelcontextprotocol.io)
- [langchain-mcp-adapters GitHub](https://github.com/langchain-ai/langchain-mcp-adapters)
- [FastMCP SDK 文档](https://gofastmcp.com)
