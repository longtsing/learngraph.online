...
![Flow Diagram](images/state-reducers-output-4-0.jpg)
...
![Flow Diagram](images/state-reducers-output-7-0.jpg)
...
![Flow Diagram](images/state-reducers-output-11-0.jpg)
...
![Flow Diagram](images/state-reducers-output-14-0.jpg)
...
![Flow Diagram](images/state-reducers-output-22-0.jpg)
...
print("\n=== Reducer 机制演示成功！===")
print("并行节点 node_2 和 node_3 的结果通过 operator.add 自动合并，而不是冲突")
```
